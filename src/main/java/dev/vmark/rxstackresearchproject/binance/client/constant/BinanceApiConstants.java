package dev.vmark.rxstackresearchproject.binance.client.constant;
...
public class BinanceApiConstants {
   ...
   * Streaming API base URL.
   */
  public static final String WS_API_COMBINED_STREAMS_URL = "wss://fstream.binance.com/stream?streams=";
